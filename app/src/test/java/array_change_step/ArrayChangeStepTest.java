...
//                new int[]{3,4,3,4,1,2,3,7,8,9,3,4,3,4,1,2,3,7,8,9}));
        ...
        int[] arrayStart = new int[2_000_000];
        int[] arrayGoal = new int[2_000_000];
        for (int i = 0; i < arrayStart.length; i++) {
            arrayStart[i] = i;
            arrayGoal[(arrayGoal.length-1) - i] = i;
        }
        assertEquals(1_000_000, ArrayChangeStep.execute_map(arrayStart, arrayGoal));
